...
export const SERVICE_DEFS: ServiceDef[] = [
  ...
  { id: "banking", name: "Banking", icon: "bank", desc: "Corporate and personal bank-account introductions with the banks we work with.", priceFrom: "€900", billing: "one-off", timeline: "2–5 weeks", docs: ["Passport", "Proof of Address"] },
];
