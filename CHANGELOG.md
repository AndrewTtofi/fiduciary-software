...
## [2.0.0](https://github.com/AndrewTtofi/fiduciary-software/compare/v1.1.0...v2.0.0) (2026-09-03)


### ⚠ BREAKING CHANGES

* the `partner` Role value, `ClientService.assignedPartnerId` and the `Application` table are dropped; prod needs a one-off `prisma db push --accept-data-loss` after this deploys.
...
* **admin:** design pass, firm self-service, and portal-off correctness ([#26](https://github.com/AndrewTtofi/fiduciary-software/issues/26)) ([a24723b](https://github.com/AndrewTtofi/fiduciary-software/commit/a24723b07d125ce691f46284be37a434817f0f7c))
* **admin:** provision pre-verified client accounts from the Users page ([#13](https://github.com/AndrewTtofi/fiduciary-software/issues/13)) ([b62470d](https://github.com/AndrewTtofi/fiduciary-software/commit/b62470d85a88b7ac0db56514f1df3a8d71e1aeff))
...
* **auth:** add a show/hide password toggle to the login form ([7b5c37a](https://github.com/AndrewTtofi/fiduciary-software/commit/7b5c37ab7c59d9d43bbf579a242c76cea8daf7c5))
...
* click-first booking funnel, post-call activation link, Excel export and full-width tables ([b327995](https://github.com/AndrewTtofi/fiduciary-software/commit/b3279959062e31685c6f4b265cf1b1bccdf29f61))
...
* **crm:** coherent pipeline stages and a slide-over record drawer ([#16](https://github.com/AndrewTtofi/fiduciary-software/issues/16)) ([69d76dd](https://github.com/AndrewTtofi/fiduciary-software/commit/69d76ddf406580df2e4ae94a80181716febd9533))
* **crm:** convert leads to client accounts and open records in a detail modal ([#15](https://github.com/AndrewTtofi/fiduciary-software/issues/15)) ([8146af0](https://github.com/AndrewTtofi/fiduciary-software/commit/8146af0d3e49845674071ebd968ed95e3c1f3332))
...
* hero tax calculator, CY gov tax resources, and client-login toggle ([#21](https://github.com/AndrewTtofi/fiduciary-software/issues/21)) ([f71e32c](https://github.com/AndrewTtofi/fiduciary-software/commit/f71e32c08f7a2e3b3945d9e34c14a702d2d188d1))
...
* **marketing:** add Georgia's photograph to the Who-takes-your-call card ([#43](https://github.com/AndrewTtofi/fiduciary-software/issues/43)) ([df87dc9](https://github.com/AndrewTtofi/fiduciary-software/commit/df87dc9bd05bd7e721db3b912145342acfe22ba9))
* **marketing:** neutralize firm-specific default content for white-label use ([3bb96c7](https://github.com/AndrewTtofi/fiduciary-software/commit/3bb96c7520dd26b9e2fc6ecdc79dde5adec22af5))
* **marketing:** rebuild the public site to Georgia's website review ([#39](https://github.com/AndrewTtofi/fiduciary-software/issues/39)) ([39164da](https://github.com/AndrewTtofi/fiduciary-software/commit/39164da47db435e8780c2444d2edd89b82a490e6))
* **marketing:** redesign public site to the approved black/gold concept ([3ff141c](https://github.com/AndrewTtofi/fiduciary-software/commit/3ff141c855ebaafbb5cb4e88d83c31670117666e))
* **marketing:** restructure the public site UI to the v2 prototype ([#30](https://github.com/AndrewTtofi/fiduciary-software/issues/30)) ([9b27c05](https://github.com/AndrewTtofi/fiduciary-software/commit/9b27c051f22f9c7aacd7536e98bdb4bf746b4746))
...
* **portal:** client-portal v2 prototype skin, email-free auth, calculator keep-box fix ([#32](https://github.com/AndrewTtofi/fiduciary-software/issues/32)) ([c6c8f64](https://github.com/AndrewTtofi/fiduciary-software/commit/c6c8f64778e109a76a3951988f58ecf04f7ee464))
...
* remove the partner role, workspace and marketplace ([#44](https://github.com/AndrewTtofi/fiduciary-software/issues/44)) ([ad1d1af](https://github.com/AndrewTtofi/fiduciary-software/commit/ad1d1af52a253c590da00bb68c057dee89c9b951))
...
* **seed:** rebrand demo data to axenorconsulting.com and add super-admin password reset ([098326a](https://github.com/AndrewTtofi/fiduciary-software/commit/098326a3736dba48d50c746962f8cd69291bc0f6))
...
* starter-tier platform wall, staff checklist, cookie consent, and hard-booking with real calendar availability ([6a5ae0d](https://github.com/AndrewTtofi/fiduciary-software/commit/6a5ae0db97af8874b0119caf79ecbf38b30e7800))
...
* **ui:** rebrand the public site to the approved ORO design ([#22](https://github.com/AndrewTtofi/fiduciary-software/issues/22)) ([8645527](https://github.com/AndrewTtofi/fiduciary-software/commit/8645527da936666a324e470e1960b27f99c1c089))
...
* **admin:** format note/activity timestamps in the firm's zone to avoid a hydration mismatch ([#41](https://github.com/AndrewTtofi/fiduciary-software/issues/41)) ([2376736](https://github.com/AndrewTtofi/fiduciary-software/commit/2376736e944b9cd3ef808645a270187fc3931772))
...
* **auth:** say when a sign-up email already exists; wrap long values in the portal ([#40](https://github.com/AndrewTtofi/fiduciary-software/issues/40)) ([0e04010](https://github.com/AndrewTtofi/fiduciary-software/commit/0e040109fd560cf78c2f9c43bc4640e30124aea6))
...
* **ci:** demote the legacy seed partner account so the enum drop can apply ([aa17bd5](https://github.com/AndrewTtofi/fiduciary-software/commit/aa17bd5a02c0e14495c1c1b77360184da7d8b840))
...
* **ci:** stop docker compose exec swallowing the db-sync script over ssh ([f55e36b](https://github.com/AndrewTtofi/fiduciary-software/commit/f55e36bf197b4ea8f15bfce14c215d7cf182c5b4))
...
* **compliance:** create the compliance file on demand instead of 404ing ([#11](https://github.com/AndrewTtofi/fiduciary-software/issues/11)) ([e190a24](https://github.com/AndrewTtofi/fiduciary-software/commit/e190a24c59005650012955d63daac100e5487c27))
...
* **content:** version the stored site content so the reviewed wording overrides the July admin copy ([#42](https://github.com/AndrewTtofi/fiduciary-software/issues/42)) ([09d173a](https://github.com/AndrewTtofi/fiduciary-software/commit/09d173ac4a6739c52daa63e1dc088dbdb31daf43))
...
* **deploy:** pull this repo's GHCR image, not oro-corp's ([b85d637](https://github.com/AndrewTtofi/fiduciary-software/commit/b85d63787a6e90e4f9f55010b079c33e54cf6949))
...
* **marketing:** stop the calculator's animated figures clipping their last digit ([#31](https://github.com/AndrewTtofi/fiduciary-software/issues/31)) ([7788360](https://github.com/AndrewTtofi/fiduciary-software/commit/7788360757f1558eabced42aec16347c3a791c87))
* **marketing:** stop the hero fading to a blank screen while scrolling on mobile ([#46](https://github.com/AndrewTtofi/fiduciary-software/issues/46)) ([d726cc9](https://github.com/AndrewTtofi/fiduciary-software/commit/d726cc97b747bc56462caed9cdfe106038fdd90a))
...
* **ui:** stop page-enter animation from trapping fixed overlays ([#14](https://github.com/AndrewTtofi/fiduciary-software/issues/14)) ([6920271](https://github.com/AndrewTtofi/fiduciary-software/commit/69202719eae6a8521fcf23153ba22d019471faf2))


### 📦 Dependencies

* bump next to 16.3.2, pg to 8.23.0 and remaining minor/patch updates ([abb4005](https://github.com/AndrewTtofi/fiduciary-software/commit/abb4005ede6b2634bb652ba44227a3819488e8ce))
...
* **deps:** bump the prod-minor-patch group across 1 directory with 12 updates ([#29](https://github.com/AndrewTtofi/fiduciary-software/issues/29)) ([164a551](https://github.com/AndrewTtofi/fiduciary-software/commit/164a5514ed6822aeea0cc87a9c7724d171960927))
...
* add an on-demand workflow to apply destructive prisma schema changes on the box ([#45](https://github.com/AndrewTtofi/fiduciary-software/issues/45)) ([ed8dce7](https://github.com/AndrewTtofi/fiduciary-software/commit/ed8dce738f8726f2987bf308a7693affcc1c5945))
...
* allow CI to be triggered manually ([d94d7fd](https://github.com/AndrewTtofi/fiduciary-software/commit/d94d7fd0e72bdcc68ea9120f38aa4b3fc654dac1))
* bump actions/setup-node in the actions group across 1 directory ([#18](https://github.com/AndrewTtofi/fiduciary-software/issues/18)) ([d59c43e](https://github.com/AndrewTtofi/fiduciary-software/commit/d59c43ee9619706dc86b37d1fe80a2e1c04d6497))
...
* **deploy:** authenticate box git fetch and GHCR pull with the job token ([f0919ec](https://github.com/AndrewTtofi/fiduciary-software/commit/f0919ec0bbad2a1872259419c79e938ed3882907))
...
## [1.1.0](https://github.com/AndrewTtofi/oro-corp/compare/v1.0.0...v1.1.0) (2026-07-04)


### ✨ Features

* **admin:** client-dashboard controls, logo upload, onboarding & link fixes ([#40](https://github.com/AndrewTtofi/oro-corp/issues/40)) ([16b0461](https://github.com/AndrewTtofi/oro-corp/commit/16b046171408b1fa2fa9df259ae1e49fa2d5688d))
* **branding:** white-label all user-facing ORO references ([#37](https://github.com/AndrewTtofi/oro-corp/issues/37)) ([1c7bfe4](https://github.com/AndrewTtofi/oro-corp/commit/1c7bfe4ff5cce0fc76ced4b1c47a8da3e64b967f))
* **marketing:** redesign public site to the approved black/gold concept ([3ff141c](https://github.com/AndrewTtofi/oro-corp/commit/3ff141c855ebaafbb5cb4e88d83c31670117666e))
* **ui:** prompt-hero advisor, mobile-polish partner network + footer ([#39](https://github.com/AndrewTtofi/oro-corp/issues/39)) ([bfad216](https://github.com/AndrewTtofi/oro-corp/commit/bfad21663e50dc4044aac035f6022fb4b9396a75))


### 🐛 Bug Fixes

* **deploy:** prune dangling images before pull to avoid disk exhaustion ([#38](https://github.com/AndrewTtofi/oro-corp/issues/38)) ([f810259](https://github.com/AndrewTtofi/oro-corp/commit/f810259b2b314d73ae210fa08dbfa9700ea087f2))
* **notify:** summarise deploys from commits, not the changelog ([87cff32](https://github.com/AndrewTtofi/oro-corp/commit/87cff328e9d56885449a85656523806d4f0373ae))
* **notify:** summarise deploys from commits, not the changelog ([63cfc25](https://github.com/AndrewTtofi/oro-corp/commit/63cfc25032837703099a455e9401c21247595040))


### 📦 Dependencies

* **deps:** bump ical-generator from 7.2.0 to 11.0.0 ([#45](https://github.com/AndrewTtofi/oro-corp/issues/45)) ([0a779f0](https://github.com/AndrewTtofi/oro-corp/commit/0a779f02954ae3a98919f0e94f08ef4ce887211c))
* **deps:** bump node-cron from 3.0.3 to 4.5.0 ([#49](https://github.com/AndrewTtofi/oro-corp/issues/49)) ([a120ac1](https://github.com/AndrewTtofi/oro-corp/commit/a120ac12571b8e79fbc1cdfe5e3c27306df8f7e3))
* **deps:** bump nodemailer from 6.10.1 to 9.0.3 ([#46](https://github.com/AndrewTtofi/oro-corp/issues/46)) ([6707931](https://github.com/AndrewTtofi/oro-corp/commit/670793145fd06c28436aa8cc98f8b055b80c820f))
* **deps:** bump the prod-minor-patch group with 2 updates ([#44](https://github.com/AndrewTtofi/oro-corp/issues/44)) ([cb1b002](https://github.com/AndrewTtofi/oro-corp/commit/cb1b002793795b7d183842b033202aa0680eae5f))
* **deps:** bump zod from 3.25.76 to 4.4.3 ([#48](https://github.com/AndrewTtofi/oro-corp/issues/48)) ([634a8d8](https://github.com/AndrewTtofi/oro-corp/commit/634a8d857d3fd15f12d04f281eb5b9afe8618aae))


### 🤖 CI/CD

* bump googleapis/release-please-action in the actions group ([#41](https://github.com/AndrewTtofi/oro-corp/issues/41)) ([e0a6538](https://github.com/AndrewTtofi/oro-corp/commit/e0a6538cf227e18f8900419770bf748bb2c54cf2))
* **deploy:** authenticate box git fetch and GHCR pull with the job token ([f0919ec](https://github.com/AndrewTtofi/oro-corp/commit/f0919ec0bbad2a1872259419c79e938ed3882907))
