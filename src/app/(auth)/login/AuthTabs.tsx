...
function PasswordInput(props: Omit<React.ComponentProps<"input">, "type" | "className">) {
  const [visible, setVisible] = useState(false);
  return (
    <div style={{ position: "relative" }}>
      <input {...props} type={visible ? "text" : "password"} className="input" style={{ width: "100%", paddingRight: 44 }} />
      <button
        type="button"
