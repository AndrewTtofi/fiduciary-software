...
export const metadata = {
  ...
  description:
    "Estimate your effective tax rate in Cyprus and compare it with your country: corporate income tax, GESY and the IP Box regime. Free, illustrative estimate.",
};
...
const CY_GOV_LINKS: { href: string; title: string; desc: string }[] = [
  ...
  },
  {
    ...
    title: "Companies and Direct Taxation",
      ...
      <section className="phero grid-bg">
        <div className="mk-container">
          ...
          <p className="sub">
            ...
            GESY, the IP Box regime, and what the same profit costs you at home. An
            illustrative estimate in seconds.
          </p>
        </div>
      </section>
          ...
          <div className="calc-grid">
            <div>
              ...
              <p className="body">
                ...
                regime</b> can be taxed at an effective <b>2.5%</b>.
              </p>
              <p className="body">
