...
/** Meridian footer — light surface with a hairline top border (no navy band):
 *  brand + blurb left, three link columns, then a bottom meta row with the
 *  statutory line and copyright. */
